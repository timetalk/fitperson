# Generated by Django 2.2 on 2021-07-27 06:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[(1, 'HOD'), (2, 'Staff'), (3, 'Student'), (4, 'SchoolAdmin'), (5, 'DEO')], default=1, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fit_person_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.FitPersonName')),
                ('household_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.HouseHoldDetail')),
                ('school_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.SchoolName')),
                ('session_year_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.SessionYearModel')),
                ('streem_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_management_app.StudentStreem')),
            ],
        ),
        migrations.CreateModel(
            name='StudentResults',
